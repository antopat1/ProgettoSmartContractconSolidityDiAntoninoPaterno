...
contract CourseCommerceManager {
    ...
    function addProduct(string memory _name, uint256 _priceInWei) public onlyOwner {
        ...
        emit ProductAdded(totalProductsCount, _name, _priceInWei);
    }
    ...
    function purchaseProduct(uint256 _productId) public payable {
        ...
        require(msg.value == productToBuy.priceInWei, "L'importo inviato non corrisponde al prezzo del prodotto.");
